...
#define STRING_VERSION_CONFIG_H "25-11-2012" //Personal revision number for changes to THIS file.
...
#define DEFAULT_HYSTERESIS_MM         0, 0, 0, 0  // X, Y, Z, E hysteresis in mm. These are the extra distances that are performed when an axis changes direction to compensate for any mechanical hysteresis your printer has. // GMM --> NeilMartin hysteresis fix
